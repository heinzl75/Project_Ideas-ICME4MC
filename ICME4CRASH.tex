...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{step1_thermo_kinetics.png}
  \caption{Stufe 1: Thermo-kinetische Prozesssimulation als Basis der
           metallurgischen Zustandsvorhersage.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{step2_microstructure_cube.png}
  \caption{Stufe 2: Generierung eines stochastischen 3D-Gefügezwillings
           (SVE) aus den Prozessdaten.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{step3_crystal_plasticity.png}
  \caption{Stufe 3: Virtuelle mikromechanische Prüfung mittels
           Kristallplastizität.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{step4_failure_surface.png}
  \caption{Stufe 4: KI-gestützte Homogenisierung und Aufbau einer
           makroskopischen Versagensfläche.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{step5_material_card.png}
  \caption{Stufe 5: Überführung der virtuellen Kurven in kalibrierte
           Crash-Materialkarten.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{step6_workflow_overview.png}
  \caption{Gesamtüberblick des automatisierten ICME-Workflows von der
           Legierung bis zur anwendbaren Crashkarte.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\textwidth]{approach2_pragmatic_ai_new.pdf}
  \caption{Säule~2: Der \emph{Pragmatic-AI}-Pfad -- KI als direkte Brücke
           zwischen experimentell verifizierten Gefügeparametern und
           crash-relevanten Materialkarten.}
\end{figure}
